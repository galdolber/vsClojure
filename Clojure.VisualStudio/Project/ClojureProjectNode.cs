...
namespace Clojure.VisualStudio.Project
{
    ...
    public class ClojureProjectNode : ProjectNode
    {
        ...
        {
            imageList = Microsoft.VisualStudio.Project.Utilities.GetImageList(typeof (ClojureProjectNode).Assembly.GetManifestResourceStream("Clojure.VisualStudio.Project.Resources.ClojureImageList.bmp"));
        }
